# ArcXos Linux Slim Edition System Documentation

This documentation provides an in-depth guide on how the ArcXos Slim build profile is structured, customized, and maintained. It is intended for developers who wish to customize the ISO, update the theme, modify default packages, or configure post-installation parameters.

---

## 🏗️ System & Build Architecture

ArcXos Slim uses the `archiso` framework to compile a bootable live ISO. The build configuration is organized into standard directory layouts:
...
ArcXos Slim features a variety of curated high-quality wallpapers. They are placed in:
...
1. Open [packages.x86_64](file:///home/arunachalam/blackarch-iso/packages.x86_64).
